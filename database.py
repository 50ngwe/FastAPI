...
def conn():
    return psycopg2.connect(database="Cars", user="techadmin@vehicle-inventory-fastapi-server", password="Mustwork!!", host="vehicle-inventory-fastapi-server.postgres.database.azure.com", port="5432")
